...
import com.ssafy.a105.api.request.UserLoginPostReq;
import com.ssafy.a105.api.response.UserLoginPostRes;
import com.ssafy.a105.api.service.UserService;
import com.ssafy.a105.common.model.response.BaseResponseBody;
import com.ssafy.a105.common.util.JwtTokenUtil;
...
public class AuthController {
    ...
    public ResponseEntity<UserLoginPostRes> login(@RequestBody @ApiParam(value="로그인 정보", required = true) UserLoginPostReq loginInfo) {
        ...
        if(passwordEncoder.matches(password, user.getPassword())) {
            ...
            return ResponseEntity.ok(UserLoginPostRes.of(200, "Success", JwtTokenUtil.getToken(userId),user.getId()));
        }
